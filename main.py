...
def selectImage(imageNumber):
    ...
    img1 = Image.open('/Users/chosenone/Desktop/made/baby/img1.tif')
    list.append(img1)

    for i in range(1, imageNumber):
        # tempImage = Image.open('image/image'+str(i+1)+'.tif')
        tempImage = Image.open('/Users/chosenone/Desktop/made/baby/img' + str(i + 1) + '.tif')
...
if __name__ == '__main__':
    ...
    # 构造LR图像
    sourceimage = Image.open('/Users/chosenone/Desktop/made/butterfly/butterfly.bmp')
    Images,shift = create_images(sourceimage, 2, 16)

    # 进行超分辨率重构
    # Images = selectImage(32)  # 加载已有LR图像
    #
    # grayImages = []
    ...
    # img = Image.open('/Users/chosenone/Desktop/made/baby/baby.bmp')
    #
